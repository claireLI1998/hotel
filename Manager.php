...
<html>
    ...
    <body>
        ...
        <form method="POST" action="Manager.php"> <!--refresh page when submitted-->
         ...
         <a href="main.php" class="far" target="_blank">Find Maintenance Request</a>

        <hr />

        <h2>Assign Pet Service</h2>
        <form method="POST" action="Manager.php"> <!--refresh page when submitted-->
            <input type="hidden" id="insertPs" name="insertPs">
            Worker Id: <input type="text" name="insID"> <br /><br />
            Service ID: <input type="text" name="insPs"> <br /><br />

            <input type="submit" value="Insert" name="insertSubmit"></p>
        </form>
        <a href="ppp.php" class="far" target="_blank">Find Pet Service Request</a>
        ...
        <hr />
        <h2>Check Custmers who requested all Pet Service</h2>
        <form method="GET" action="allps.php"> <!--refresh page when submitted-->
            <input type="hidden" id="Division" name="Division">
            <input type="submit" name="countallps"></p>
        </form>
        ...
        <h2>Check total pet service charges</h2>
        <form method="GET" class="form-signin" action="totalsp.php"> <!--refresh page when submitted-->
         ...
         <h2>Check hotel workers information</h2>
